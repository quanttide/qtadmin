...
void main() {
  ...
  group('TenantInfo', () {
    test('fromJson parses correctly', () {
      final json = {'name': '量潮科技', 'icon': 'business_outlined'};
  ...
  group('NavMetadata', () {
    test('fromJson parses founder metadata correctly', () {
      ...
      expect(metadata.tenant.name, '量潮创始人');
    ...
    test('fromJson parses company metadata correctly', () {
      ...
      expect(metadata.tenant.name, '量潮科技');
    ...
    test('allItems flattens all items across sections', () {
      final json = {
        'tenant': {'name': '测试', 'icon': 'person_outline'},
        'sections': [
          {'items': [{'label': 'A', 'icon': 'today_outlined', 'pageType': 'panorama'}]},
          {'items': [{'label': 'B', 'icon': 'psychology_outlined', 'pageType': 'thinking'}, {'label': 'C', 'icon': 'edit_outlined', 'pageType': 'writing'}]},
          {'items': [{'label': 'D', 'icon': 'people_outline', 'pageType': 'function_detail'}]},
        ],
      };
      final metadata = NavMetadata.fromJson(json);
