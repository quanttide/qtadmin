...
from fastapi_quanttide_hr.models.talent import Talent
from fastapi_quanttide_hr.schemas.candidate import CandidateRead, CandidateUpdate
from fastapi_quanttide_hr.schemas.application import ApplicationRead
